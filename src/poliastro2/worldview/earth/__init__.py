...
Description
-----------
This subpackage provides Earth focused orbital mechanics routines. Including visualizing Earth data,
atmospheric models, ground tracks, and geospatial utilities for mapping.
...
from poliastro2.math.perturbations import J2_perturbation
from poliastro2.math.propagation import func_twobody
from poliastro2.worldview.earth.enums import EarthGravity
