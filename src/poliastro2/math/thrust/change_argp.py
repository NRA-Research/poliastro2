...
from poliastro2.math.twobody.elements import circular_velocity, rv2coe
...
def change_argp(k, a, ecc, argp_0, argp_f, f):
    """Guidance law from the model. Thrust is aligned with an inertially fixed direction
    perpendicular to the semimajor axis of the orbit.
