...
from poliastro2.math.twobody.elements import (
    coe_rotation_matrix,
    rv2coe,
    rv_pqw,
)
...
def bielliptic(k, r_b, r_f, rv):
    r"""Calculate the increments in the velocities and the time of flight of the
    maneuver.
...
def correct_pericenter(k, R, J2, max_delta_r, v, a, inc, ecc):
    """Calculates the time before burning and the velocity vector in direction of the
    burn.
