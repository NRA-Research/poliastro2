...
def spherical_to_cartesian(v):
    r"""Compute cartesian coordinates from spherical coordinates (norm, colat, long).
...
def planetocentric_to_AltAz(theta, phi):
    r"""Defines transformation matrix to convert from Planetocentric coordinate system to
