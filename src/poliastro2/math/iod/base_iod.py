...
from poliastro2.math.special import hyp2f1b, stumpff_c2 as c2, stumpff_c3 as c3
...
def _compute_psi(x, y, ll):
    ...
    "The auxiliary angle psi is computed using Eq.(17) by the
    appropriate inverse function"
    """
    if -1 <= x < 1:
        # Elliptic motion
