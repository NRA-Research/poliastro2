...
from poliastro2.math.twobody.angles import E_to_M, E_to_nu, nu_to_E
from poliastro2.math.twobody.elements import coe2rv, rv2coe
...
def gooding(k, r0, v0, tof, numiter=150, rtol=1e-8):
    """Solves the Elliptic Kepler Equation with a cubic convergence and accuracy better
    than 10e-12 rad is normally achieved. It is not valid for eccentricities equal or
    higher than 1.0.
