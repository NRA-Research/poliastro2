...
from poliastro2.math.twobody.elements import coe_rotation_matrix, rv2coe
from poliastro2.math.util import planetocentric_to_AltAz
...
def elevation_function(k, u_, phi, theta, R, R_p, H):
    """Calculates the elevation angle of an object in orbit with respect to a location
    on attractor.
