...
from poliastro2.math.propagation import pimienta_coe as pimienta_fast
...
class PimientaPropagator:
    """Kepler solver for elliptic orbits based on a 15th order polynomial with
    accuracies around 10e-5 for elliptic case and 10e-13 in the hyperbolic regime.
