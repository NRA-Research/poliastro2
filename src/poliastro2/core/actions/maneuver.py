...
from poliastro2.math.iod.izzo import lambert as lambert_izzo
from poliastro2.math.maneuver import (
...
class Maneuver:
    ...
    def correct_pericenter(cls, orbit, max_delta_r):
        """Returns a Maneuver with the time before burning and the velocity vector in
