...
from poliastro2.worldview.solar_sys.bodies import Earth, Mars
from poliastro2.worldview.earth import EarthSatellite
from poliastro2.worldview.earth.enums import EarthGravity
from poliastro2.core.spacecraft import Spacecraft
